...
var INITIAL_PRODUCTS = [
  ...
  },
  {
    ...
    image: "https://static.tossdown.com/images/4ce209c4-a1fb-4a1c-a539-31abb6a2f1f5.webp",
    rating: 4.6,
    isPopular: true,
    tags: ["Creamy", "Garlic"]
  },
...
var INITIAL_REVIEWS = [
  ...
  },
  {
    ...
    name: "Ali Khan",
    rating: 5,
    comment: "The best burgers in Islamabad. Fast delivery and amazing taste.",
    date: "1 Day ago",
  ...
  },
  {
    ...
    name: "Sana Mir",
    rating: 5,
    comment: "Absolutely love their Loaded Fries! The cheese sauce is so rich, and it is packed with zinger chunks. It arrived steaming hot in G-13. A must-try!",
    date: "4 Days ago",
  ...
  },
  {
    ...
    name: "Bilal Shah",
    rating: 4.9,
    comment: "Been ordering their Beef Smash Burger (Special) for months now. Consistently great taste, juicy patties, and fresh brioche buns. Delivery is always within 30 minutes to E-11.",
    date: "5 Days ago",
  ...
  },
  {
    ...
    name: "Ayesha Malik",
    rating: 5,
    comment: "Ordered their Family combo deal for our hostel get-together. The zinger wrap and smashed burgers were excellent, and the Margarita is extremely refreshing. Very friendly dispatchers!",
    date: "6 Days ago",
  ...
  },
  {
    ...
    name: "Usman Farooq",
    rating: 4.8,
    comment: "Highly recommended zinger burgers! Super crispy chicken breast fillet and fresh lettuce. The custom hot sauce they send on request is amazing. Fast delivery to Golra.",
    date: "1 Week ago",
  ...
  },
  {
    ...
    name: "Mariam Khan",
    rating: 5,
    comment: "Mint Margarita here is the absolute best in town! Combined with their Garlic Mayo Fries, it makes the perfect mid-day snack. Fast delivery and neat packaging in F-11.",
    date: "1 Week ago",
  ...
  },
  {
    ...
    name: "Kamran Lodhi",
    rating: 4.7,
    comment: "Great value for money. Their Shawarmas are loaded with chicken and have that perfect local spicy kick. Excellent service and fast delivery to G-14.",
    date: "2 Weeks ago",
