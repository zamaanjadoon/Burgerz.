...
export const INITIAL_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    name: 'Bilal Shah',
    rating: 4.9,
    comment: 'Been ordering their Beef Smash Burger (Special) for months now. Consistently great taste, juicy patties, and fresh brioche buns. Delivery is always within 30 minutes to Athaal Road.',
    date: '5 Days ago',
  ...
  },
  {
    ...
    name: 'Mariam Khan',
    rating: 5,
    comment: 'Mint Margarita here is the absolute best in town! Combined with their Garlic Mayo Fries, it makes the perfect mid-day snack. Fast delivery and neat packaging in Phulgran.',
    date: '1 Week ago',
    avatar: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=100&auto=format&fit=crop&q=80',
    tag: 'Phulgran Resident',
  },
  {
    id: 'r10',
    name: 'Kamran Lodhi',
    rating: 4.7,
    comment: 'Great value for money. Their Shawarmas are loaded with chicken and have that perfect local spicy kick. Excellent service and fast delivery to Dhok Abbasi.',
    date: '2 Weeks ago',
    avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&auto=format&fit=crop&q=80',
    tag: 'Dhok Abbasi Diner',
  },
];
